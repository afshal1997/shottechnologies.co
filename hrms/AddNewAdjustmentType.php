...
{	
	...
	if($msg=="")
	{
			$query="INSERT INTO adjustmenttypes SET DateAdded=NOW(),
				Name = '" . dbinput($Name) . "',
				Status='".(int)$Status . "',
				Type='".(int)$Type . "'";
			...
			$_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>Adjustment Type has been Added.</b>
			</div>';
			
			redirect("AddNewAdjustmentType.php");
	}
...
<head>
<meta charset="UTF-8">
<title>Add Adjustment Type</title>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Adjustment Type</li>
      </ol>
    </section>
    <!-- Main content -->
