...
<title>Employees In My Supervision</title>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Employees In My Supervision<small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Employees In My Supervision</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Employees In My Supervision</h3>
					...
					<input type="hidden" id="action" name="action" value="" />
						...
						<select name="Employee" id="myselect" class="js-example-disabled-results form-control">
						  <option value="" >All Employees</option>
							<?php
							 $query = "SELECT ID,EmpID,FirstName,LastName,Department,Designation FROM employees where ID <> 0 AND Supervisor = " . $_SESSION['UserID'] . " ".($_SESSION['EmpTypeEmployeeFrm'] != '' ? ' AND Status = "'.$_SESSION['EmpTypeEmployeeFrm'].'"' : '')." ORDER BY ID ASC";
							$res = mysql_query($query);
							while($row = mysql_fetch_array($res))
							{
