...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="RequestsDesk.php"><i class="fa fa-dashboard"></i>Requests</a></li>
    ...
    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      <section class="content">
       <div class="box-footer" style="text-align:right;">
                ...
                <button class="btn btn-primary margin" type="button" onClick="location.href='RequestsDesk.php'">Cancel</button>
            </div>
              <?php
		  		echo $msg;
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <?php 
				echo '<input type="text" maxlength="200" id="Title" name="Title" class="form-control"  value="'.$getTitle.'" />';
				?>
                </div>
				
				<div class="form-group">
                  <label id="labelimp">Request Type: </label>
					<input type="text" name="RequestType"  class="form-control" value="<?php echo $getRequestType; ?>">
                </div>
                ...
                <div class="form-group">
                  <label id="labelimp" >Request Status</label>
						<select class="form-control" name="RequestStatus">
							...
							<option value="Reject" <?php echo ($getRequestStatus == 'Reject') ? 'selected' : ''; ?>>Reject</option>
							<option value="Approved" <?php echo ($getRequestStatus == 'Approved') ? 'selected' : ''; ?>>Approved</option>
                ...
                <div class="form-group">
                 ...
                 <div class="selectBox" onclick="showCheckboxes2()">
					...
					<div id="checkboxes2" style="height:250px; overflow:scroll;">						
						<?php
						 $query = "SELECT ID,EmpID,FirstName,LastName,Department,Designation,Role FROM employees where Status = 'Active' and Role != 'Employee'";
				...
				<div class="form-group">
                  ...
                  <?php 
				    echo '<textarea id="Description" name="Description" class="form-control" value="'.$getDescription.'" >' . $getDescription . '</textarea>';
				    ?>
                </div>
