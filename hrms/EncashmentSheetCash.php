              ...
              <div id="tblExport">
                ...
                <table style="font-size:8px;" id="dataTable" class="table table-bordered invoice" style="background-color:white">
                  ...
                  <tbody>
					...
					<?php 
					$query3 = "SELECT bd.ID AS EncashmentdetailsID,b.EncashmentDate,e.ID,e.AccountNumber,DATE_FORMAT(e.JoiningDate, '%D %b %Y') AS JoiningDate,bd.ID AS PayrollID,e.EmpID,e.Designation,e.CNICNumber,e.CompanyID,e.FirstName,e.LastName,bd.Basic,bd.NetPay,bd.BankorCash,bd.Gross,bd.TotalDays,bd.OtherAllowances FROM employees e LEFT JOIN encashmentdetails bd ON e.ID = bd.EmpID LEFT JOIN encashment b ON b.ID = bd.EncashmentID WHERE e.ID <> 0 AND e.CompanyID = ".$compid." AND e.Location = ".$row2['ID']." AND bd.EncashmentID = ".$ID." AND bd.BankorCash = 'Cash' ORDER BY e.ID ASC";
