              ...
              <div class="col-lg-12 col-xs-12">
				...
				<table style="font-size:12px;" id="dataTable" class="table table-bordered invoice" style="background-color:white">
                  ...
                  <tbody>
					...
					$EnglishCurrency = round(bank_transfer_amount_encashment($ID,$compid,$rowB['Name']),2);
					...
					echo 'Rs:'.bank_transfer_amount_encashment($ID,$compid,$rowB['Name']).'/= ';
