...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
                ...
                FROM request_desks LEFT JOIN employees ON employees.EMPID = request_desks.AddedBy where employees.EMPID = '$EMPID'";
				if($Keywords != "")
		...
		?>
                    <tr>
					  ...
					  elseif($row["RequestStatus"] == 'Reject'):
					    echo '<mark style="background-color:#ff0">'.$row["RequestStatus"].'</mark>';
