...
{	
	...
	if($msg=="")
	{
		...
		$query="INSERT INTO banks SET Status='".(int)$Status . "', DateAdded=NOW(),
				Name = '" . dbinput($Bank) . "',AccountNo = '" . dbinput($AccountNo) . "',LetterHead = '" . $LetterHead . "'";
		...
		<b>Bank has been added.</b>
		</div>';		

		redirect("AddNewBank.php");	
	}
