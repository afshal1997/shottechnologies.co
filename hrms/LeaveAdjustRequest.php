...
{			
	...
	if($msg=="")
	{
		...
		{
			if(isset($_SESSION["LeaveAdjustRequest"]) && is_array($_SESSION["LeaveAdjustRequest"]))
			{
				foreach($_SESSION["LeaveAdjustRequest"] as $GL)
				{
				$query = "SELECT Status,LoginDate FROM roster_login_history WHERE ID IN (" . $GL . ")";
				...
				if($num > 0)
				{
					...
					{
						$query="INSERT INTO leaveadjust_requests SET 
			...
			<b>Successfully requested for All selected Special Leaves.</b>
			</div>';
					...
					if($row['Status'] == "Absent")
					{
						...
						if($num3 > 0)
						{
							...
							if($row3['CasualLeaves'] > 0.9)
							{
								...
								<i class="fa fa-ban"></i>
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								<b>Successfully requested for All selected Leaves..</b>
								</div>';
							}
							...
							else
							{
								...
								<i class="fa fa-ban"></i>
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								<b>Not Requested for All selected Leaves.</b>
								</div>';
							}
						}
						else
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Adjust Leave</li>
      </ol>
    </section>
    <!-- Main content -->
