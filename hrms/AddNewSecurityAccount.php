...
{	
	...
	{
		$query="SELECT ID FROM security WHERE EmpID = ".$EmpID."";
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>Employee already have Security Account.</b>
		</div>';
		}
	}
	...
	if($msg=="")
	{
			$query="INSERT INTO security SET DateAdded=NOW(),
				EmpID = '" . (int)$EmpID . "',
			...
			$_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>Security Account has been Added.</b>
			</div>';
			
			redirect("AddNewSecurityAccount.php");
	}
