        ...
        while($row=mysqli_fetch_array($sql_res))
        {
            ...
            <li class="person chatboxhead" id="chatbox1_<?php echo $username ?>" data-chat="person_<?php echo $id ?>" href="javascript:void(0);" onclick="javascript:chatWith('<?php echo $username ?>','<?php echo $id ?>','<?php echo $sesuserpic; ?>','<?php echo $onofst ?>')">
                <a href="javascript:void(0)">
                    <span class="userimage profile-picture min-profile-picture"><img src="<?php echo $config['imagepath']; ?><?php echo $picname; ?>" alt="<?php echo $username ?>" class="bg-theme"></span>
            <span>
...
function userProfile($con,$config) {
    ...
    <div class="">
        <div class="user-bg">
            <div class="overlay-box">
                <div class="user-content"> <a href="javascript:void(0)">
                        <img class="thumb-lg img-circle" src="<?php echo $config['imagepath']; ?><?php echo $picname; ?>" alt="<?php echo $username ?>"></a>
        ...
        <div class="user-btm-box">
            ...
            <!-- .row -->
            <div class="row text-center m-t-10">
                <div class="col-md-6 b-r"><strong>Designation</strong><p><?php echo $designation ?></p></div>
                <div class="col-md-6"><strong>Department</strong><p><?php echo $department ?></p></div>
            </div>
            <!-- /.row -->
            <hr>
            <!-- .row -->
...
function chatfrindList($con,$config) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        <li class="person chatboxhead" id="chatbox1_<?php echo $username ?>" data-chat="person_<?php echo $id ?>" href="javascript:void(0)" onclick="javascript:chatWith('<?php echo $username ?>','<?php echo $id ?>','<?php echo $sesuserpic; ?>','<?php echo $onofst ?>')">
            <a href="javascript:void(0)">
                <span class="userimage profile-picture min-profile-picture"><img src="<?php echo $config['imagepath']; ?><?php echo $picname; ?>" alt="<?php echo $username ?>" class="avatar-image is-loaded bg-theme" width="100%"></span>
                <span>
