            ...
            $.each(data.items, function(i,item){
                if (item)	{ // fix strange ie bug
                    ...
                    } else
                    {
                        ...
                        if (item.u == 2) {
                            $("#chatbox_"+chatboxtitle).prepend('<div class="col-xs-12 p-b-10"><div class="chat-image  profile-picture max-profile-picture"> <img alt="'+item.sender+'" src="'+siteurl+'./../assets/employeephotoes/'+img+'" class="bg-theme"> </div><div class="chat-body"><div class="chat-text"><h4>'+item.sender+'</h4><p>'+message_content+'</p><b>'+item.time+'</b> </div></div></div>');
                        } else
                        {
                            if(seen == 1){
                            ...
                            '<img alt="'+item.sender+'" src="'+siteurl+'./../assets/employeephotoes/'+img+'">' +
                            '</div>' +
                            '<div class="chat-body">' +
                            '<div class="chat-text">' +
    ...
    if((event.keyCode == 13 && event.shiftKey == 0) || (send == 1))  {
        ...
        if (message != '') {
            $.post(siteurl+"chat.php?action=sendchat", {to: chatboxtitle, toid: toid, message: message} , function(data){
                ...
                '<div class="chat-image  profile-picture max-profile-picture">' +
                '<img alt="'+username+'" src="'+siteurl+'./../assets/employeephotoes/'+img+'">' +
                '</div>' +
                '<div class="chat-body">' +
                '<div class="chat-text">' +
                '<h4>'+username+'</h4>' +
                ...
                if (item)	{ // fix strange ie bug
                    ...
                    if(typeof item.f != "undefined")
                    {
                        ...
                        } else if(cLenth != 0)
                        {
                            ...
                            '<div class="chat-image  profile-picture max-profile-picture">' +
                            '<img alt="' + chatboxtitle + '" src="' + siteurl + './../assets/employeephotoes/' + fromPic + '" class="bg-theme">' +
                            '</div>' +
                            '<div class="chat-body">' +
                            '<div class="chat-text">' +
                            '<h4>' + chatboxtitle + '</h4>' +
