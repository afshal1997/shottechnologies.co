...
if(isset($_POST['login']))
{
    ...
    $query = "SELECT $MySQLi_userid_field,$MySQLi_username_field,$MySQLi_password_field,$MySQLi_status_field FROM `".$config['db']['pre'].$MySQLi_user_table_name."` WHERE $MySQLi_username_field='" . $_POST['username'] . "' AND $MySQLi_password_field='" . $_POST['password'] . "' LIMIT 1";
    //echo $query; exit();
