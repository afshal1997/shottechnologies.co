...
{			
	...
	if($msg=="")
	{
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>Commission has been added.</b>
		</div>';		
		
		redirect("AddNewCommission.php");	
	}
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="Commissions.php"><i class="fa fa-dashboard"></i>Commissions</a></li>
    ...
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>" method="post" enctype="multipart/form-data" name="frmPage">
      <section class="content">
       <div class="box-footer" style="text-align:right;">
                ...
                <button class="btn btn-primary margin" type="button" onClick="location.href='Commissions.php'">Cancel</button>
            </div>
              <?php
		  		echo $msg;
