...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Interviews Calendar <small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Interviews Calendar</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <script type="text/javascript">
            $(function() {
                ...
                /* initialize the calendar
                 -----------------------------------------------------------------*/
				 <?php 
				 $sql = "SELECT ID, Title,StartDate,EndDate,StartTime,EndTime,Color FROM interviews WHERE ID <> 0";
                ...
                $('#calendar').fullCalendar({
					...
					?>
					{
						...
						allDay: false,
						url: 'InterviewsDetails.php?ID=<?php echo dboutput($row['ID']);?>',
