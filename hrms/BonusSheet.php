...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <aside class="right-side">
	...
	<div class="box-footer no-print" style="text-align:right;">
				 ...
				 <a href="BonusSheetExcel.php?ID=<?php echo $ID; ?>" class="btn btn-primary margin no-print">Excel Sheet</a>
				 <?php 
                ...
                <table style="font-size:8px;" id="dataTable" class="table table-bordered invoice" style="background-color:white">
                  ...
                  <tbody>
                    ...
                    <th colspan=""><?php echo $c; ?></th>
                     ...
                     <th><?php echo number_format($row3['NetPay']);$TTNetPay += $row3['NetPay']; ?><br><span class="no-print"><a <?php echo ($Steps != 0 ? 'disabled' : ''); ?> <?php echo (($_SESSION['RoleID'] == 'Accounts' OR $_SESSION['RoleID'] == 'Audit') ? 'disabled' : ''); ?> href="BonusUpdate.php?ID=<?php echo $row3['bonusdetailsID']; ?>&BonusID=<?php echo $ID; ?>" class="btn btn-info no-print"><i class="fa fa-money no-print"></i></a></span></th>
