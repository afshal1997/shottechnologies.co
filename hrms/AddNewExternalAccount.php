...
{	
	...
	if($msg=="")
	{
			$query="INSERT INTO externalusers SET DateAdded=NOW(),JoiningDate=NOW(),
				EmpID = 1,
			...
			$_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>External Account has been Added.</b>
			</div>';
			
			redirect("AddNewExternalAccount.php");
	}
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add External Account</li>
      </ol>
    </section>
    <!-- Main content -->
