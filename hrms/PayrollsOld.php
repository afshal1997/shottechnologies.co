...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				FROM payroll d LEFT JOIN employees e ON d.EmpID = e.ID LEFT JOIN employees a ON d.CreatedBy = a.ID WHERE d.ID <>0 ".($Employee != 0 ? ' AND d.EmpID ='.$Employee : '')." ".($Month != 0 ? ' AND d.Month ='.$Month : '')." ".($Year != 0 ? ' AND d.Year ='.$Year : '')." ORDER BY d.Month DESC,e.Department ASC,e.Designation ASC,e.FirstName ASC,e.LastName ASC";
			...
			<div class="row margin">
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                        ...
                        <div class="col-lg-3 col-xs-12">
                            <div class="form-group">
							  <select name="Month" id="Month" class="form-control">
								<option <?php echo ($Month == "" ? 'selected' : ''); ?> value="" >All Months</option>
								<?php
								$i=1;
                        ...
                        <div class="col-lg-3 col-xs-12">
                           <div class="form-group">
							  <select name="Year" id="Year" class="form-control">
								<option <?php echo ($Year == 0 ? 'selected' : ''); ?> value="" >All Years</option>
								<?php
						...
						<div class="col-lg-1 col-xs-12">
                           <div class="form-group">
							  <button type="submit" class="btn btn-block btn-sm btn-success" style="background-color:#428BCA">Find</button>
