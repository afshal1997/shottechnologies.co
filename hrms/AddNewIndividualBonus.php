...
{	
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        $import="INSERT into individual_bonuses(ID,EmpID,Percentage,Date) values('$data[0]','$data[1]','$data[2]','$data[3]')";
    ...
    $_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
		...
		<b>Individual Bonuses has been Uploaded.</b>
		</div>';
	}
	else
	{
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
		<b>Individual Bonuses Not Uploaded.</b>
		</div>';
	}

		redirect("AddNewIndividualBonus.php");	
	}
...
<head>
<meta charset="UTF-8">
<title>Add Individual Bonus</title>
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<div class="form-group">
                  <label id="labelimp" for="IndividualBonus" class="labelimp" >Upload (CSV): </label>
                  <input type="file" id="IndividualBonus" name="flPage" />
                </div>
                <input type="hidden" name="action" value="submit_form" />
              </div>
              <!-- /.box-body -->
