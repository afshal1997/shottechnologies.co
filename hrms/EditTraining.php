...
{	
	...
	if(isset($_POST["Test"]) && ctype_digit($_POST['Test']))
	...
	if($msg=="")
	{
			...
			$msg='<div class="alert alert-success alert-dismissable">
				...
				<b>Trainings has been Updated.</b>
			</div>';
...
{
	$query="SELECT ID, Title,Test,Employees,Description,StartDate,EndDate,StartTime,EndTime,Color FROM trainings WHERE  ID='" . (int)$ID . "'";
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>Edit Training</h1>
      <ol class="breadcrumb">
        <li><a href="Trainings.php"><i class="fa fa-dashboard"></i>Trainings</a></li>
    ...
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>?ID=<?php echo $ID; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      ...
      <section class="content">
        <div class="box-footer" style="text-align:right;">
          ...
          <button class="btn btn-primary margin" type="button" onClick="location.href='Trainings.php'">Cancel</button>
        </div>
        <?php
			  	echo $msg;
          ...
          <div class="box">
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<div class="form-group">
                  <label id="labelimp" for="Test" >Test: </label>
				  <select name="Test" id="Test" class="form-control">
					<option value="0" >Select Test</option>
					<?php
					 $query = "SELECT ID,TestName FROM tests where Status = 1";
					$res = mysql_query($query);
					while($row = mysql_fetch_array($res))
					{
					echo '<option '.($Test == $row['ID'] ? 'selected' : '').' value="'.$row['ID'].'">'.$row['TestName'].'</option>';
					} 
					?>
					</select>
                </div>
				...
				<div class="form-group">
                 ...
                 <div class="selectBox" onclick="showCheckboxes2()">
					...
					<div id="checkboxes2" style="height:250px; overflow:scroll;">						
						<?php
						 $query = "SELECT ID,EmpID,FirstName,LastName,Department,Designation FROM employees where Status = 'Active' AND AllowEmpLogin = 'Yes' ORDER BY Department,Designation ASC";
						$res = mysql_query($query);
						while($row = mysql_fetch_array($res))
						{						
				...
				<div class="form-group">
				  <label id="labelimp">Description or Preparation Details: </label>
					<?php
