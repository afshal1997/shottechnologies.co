...
{	
	...
	if($msg=="")
	{
		$query="UPDATE security SET DateModified=NOW(),
		...
		$msg='<div class="alert alert-success alert-dismissable">
			...
			<b>Security Account has been Updated.</b>
		</div>';	
	}
}
else
{
	$query="SELECT ID,EmpID,Status,Rights,Companies FROM security WHERE  ID='" .(int)$ID . "'";
	...
	if($num==0)
	{
		$_SESSION["msg"]='<div class="alert alert-danger alert-dismissable">
			<i class="fa fa-ban"></i>
			<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
			<b>Invalid Security Account ID.</b>
		</div>';
...
<head>
<meta charset="UTF-8">
<title>Edit Security Account</title>
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>Edit Security Account</h1>
      <ol class="breadcrumb">
        <li><a href="SecurityAccounts.php"><i class="fa fa-dashboard"></i>Security Accounts</a></li>
        <li class="active">Edit Security Account</li>
      </ol>
    </section>
    <!-- Main content -->
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>?ID=<?php echo $ID; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      ...
      <section class="content">
        <div class="box-footer no-print" style="text-align:right;">
          ...
          <button class="btn btn-primary margin" type="button" onClick="location.href='SecurityAccounts.php'">Cancel</button>
        </div>
        <?php
			  	echo $msg;
