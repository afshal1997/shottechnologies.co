...
if(isset($_SESSION['Login']) && $_SESSION['Login']==true)
	...
	if(isset($_POST["action"]) && $_POST["action"] == "submit_form")
	{
		...
		if($msg1=='' && $msg2=='')
		{	
			$query="SELECT ID,FirstName,LastName,Photo, UserName, Password ,Role,DATE_FORMAT(JoiningDate, '%b %Y') AS Added FROM developers WHERE Status = 'Active' AND AllowEmpLogin = 'Yes' AND UserName='".dbinput($username)."'";
