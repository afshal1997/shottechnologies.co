...
include("CheckAdminLogin.php");
	...
	$query="SELECT e.EmpID AS EmpCode,e.Salary,e.FirstName,e.LastName,DATE_FORMAT(e.JoiningDate, '%d-%b-%Y') as JoiningDate,e.EmpType,a.ID,a.EmpID,a.Reason,a.Code,a.Status,a.AdvanceReqID,a.Amount,DATE_FORMAT(a.RepaymentDate, '%M %Y') as Month,DATE_FORMAT(a.DateAdded, '%d-%b-%Y') as Added,DATE_FORMAT(a.RepaymentDate, '%d-%b-%Y') as RepaymentDate,a.RemainingAmount,c.Name AS Company FROM advances a LEFT JOIN employees e ON a.EmpID = e.ID LEFT JOIN companies c ON e.CompanyID = c.ID WHERE a.ID='" .(int)$ID . "'";
	...
	else
	{
		...
		$AdvanceRequestID=$rows['AdvanceReqID'];
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Advance Slip</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box box-solid" style="border:1px solid black">
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<span style="font-size:15px; font-weight:bold;">ADVANCE SALARY VOUCHER FOR THE MONTH OF <?php echo $Month; ?></span>
				</div>
