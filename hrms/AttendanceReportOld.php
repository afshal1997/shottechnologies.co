          ...
          <br>
			...
			?>
              ...
              <table class="blue table table-bordered" id="tblExport">
                  <thead class="">
					<tr class="no-print">
					<th colspan="25" style="text-align:right;background-color:white;">
		...
		?>
                    <tr>
					  ...
					  <?php
							...
							if(($TotalWorkingHoursOT - $TotalHours) > 0)
							{
								$Rate += 1;
							}
							$TotalHours = 0;
					  ...
					  {
						  echo '<i class="fa fa-star-half-o"></i><i class="fa fa-star-o"></i>';
					  }
					  else if($Rate == 2)
					  {
						  echo '<i class="fa fa-star"></i><i class="fa fa-star-o"></i>';
					  }
					  else if($Rate == 3)
					  {
					  ...
					  {
						  echo '<i style="font-size:30px;" class="fa fa-trophy"></i>';
					  }
