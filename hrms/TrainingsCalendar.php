...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Trainings Calendar <small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Trainings Calendar</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <script type="text/javascript">
            $(function() {
                ...
                /* initialize the calendar
                 -----------------------------------------------------------------*/
				 <?php 
				 $sql = "SELECT ID, Title,StartDate,EndDate,StartTime,EndTime,Color FROM trainings WHERE ID <> 0";
                ...
                $('#calendar').fullCalendar({
					...
					?>
					{
						...
						allDay: false,
						url: 'TrainingsDetails.php?ID=<?php echo dboutput($row['ID']);?>',
