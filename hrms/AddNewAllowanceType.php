...
{	
	...
	if($msg=="")
	{
			$query="INSERT INTO allowancetypes SET DateAdded=NOW(),
				Name = '" . dbinput($Name) . "',
				Status='".(int)$Status . "'";
			...
			$_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>Allowance Type has been Added.</b>
			</div>';
			
			redirect("AddNewAllowanceType.php");
	}
...
<head>
<meta charset="UTF-8">
<title>Add Allowance Type</title>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Allowance Type</li>
      </ol>
    </section>
    <!-- Main content -->
