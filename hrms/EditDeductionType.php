...
{	
	...
	if($msg=="")
	{
			...
			$query="UPDATE deductiontypes SET DateModified=NOW(),
			Name = '" . dbinput($Name) . "',
			Status='".(int)$Status . "'
			WHERE ID='".(int)$ID."'";
			...
			$msg='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>Deduction Type has been Updated.</b>
			</div>';
...
{
	$query="SELECT ID,Status,Name FROM deductiontypes WHERE  ID='" . (int)$ID . "'";
...
<head>
<meta charset="UTF-8">
<title>Edit Deduction Type</title>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Deduction Type</li>
      </ol>
    </section>
    <!-- Main content -->
