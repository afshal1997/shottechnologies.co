...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				$query="SELECT s.ID,s.Status,s.Name AS LocationName,c.Name,DATE_FORMAT(s.DateAdded, '%D %b %Y<br>%r') AS Added,DATE_FORMAT(s.DateModified, '%D %b %Y<br>%r') AS Updated
				FROM locations s LEFT JOIN companies c ON s.CompanyID = c.ID WHERE s.ID <>0 ";
				if($Keywords != "")
					$query .= " AND (s.Name LIKE '%" . dbinput($Keywords) . "%')";
      ...
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <div class="buttons">
                ...
                <button class="btn btn-success margin" type="button" onClick="location.href='AddNewLocation.php'">Add New</button>
		...
		?>
                    <tr>
                      ...
                      <td><?php echo dboutput($row['LocationName']); ?></td>
					  ...
					  <td align="center" class="noPrint"><?php if($_SESSION['RoleID'] == 'Administrator'){ ?><button class="btn btn-info margin" type="button" onClick="location.href='EditLocation.php?ID=<?php echo $row["ID"]; ?>'">Edit</button><?php } ?></td>
                    </tr>
                    <?php				
				}
			} 
