...
include("CheckAdminLogin.php");
	...
	$query="SELECT e.EmpID AS EmpCode,e.Salary,e.FirstName,e.LastName,DATE_FORMAT(e.JoiningDate, '%d-%b-%Y') as JoiningDate,e.EmpType,a.ID,a.EmpID,a.Reason,a.Code,a.LoanType,a.Amount,a.ActualAmount,a.RepaymentAmount,DATE_FORMAT(a.DateAdded, '%M %Y') as Month,DATE_FORMAT(a.DateAdded, '%d-%b-%Y') as Added,DATE_FORMAT(a.RepaymentDate, '%d-%b-%Y') as RepaymentDate,c.Name AS Company FROM loan_requests a LEFT JOIN employees e ON a.EmpID = e.ID LEFT JOIN companies c ON e.CompanyID = c.ID WHERE a.ID='" .(int)$ID . "'";
          ...
          <div class="box box-solid" style="border:1px solid black">
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<span style="font-size:15px; font-weight:bold;">LOAN REQUEST VOUCHER</span>
				</div>
				...
				<div class="col-md-8 col-xs-8" style="border-bottom:1px solid black; width:70%;">
				<?php echo number_format($ActualAmount,2) .' (<span style="font-size:13px;">'.convertNumber(round($ActualAmount )).' Only</span>)'; ?>
				</div>
				<?php } ?>
