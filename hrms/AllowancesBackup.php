...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				$query="SELECT d.ID,d.Approved,d.EmpID,d.Amount,d.Percentage,d.Type,d.Taxable,e.EmpID,e.FirstName,e.LastName,e.Department,e.Designation,a.FirstName AS fn,a.LastName AS ln,a.Department AS dep,a.Designation AS des,d.Title,DATE_FORMAT(d.Date, '%D %b %Y') AS Added
				FROM allowances d LEFT JOIN employees e ON d.EmpID = e.ID LEFT JOIN employees a ON d.ApprovedBy = a.ID WHERE d.ID <>0 AND Title <> 'House Rent' AND Title <> 'Utility' AND Title <> 'Conveyance'";
				if($Keywords != "")
  ...
  <aside class="right-side">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              </div><form action="<?php echo $self;?>" method="post" style="clear:both; margin:0 5px" class="no-print">
		...
		?>
                    <tr class="noPrint">
                      <td colspan="11" align="center" class="error"><b>No Allowance listed.</b></td>
                    </tr>
                    <?php 
			}
			else
		...
		?>
                    <tr>
					  ...
					  <td><?php echo dboutput($row["Taxable"]); ?></td>
