...
include("CheckAdminLogin.php");
	...
	$query="SELECT e.EmpID AS EmpCode,e.Salary,e.FirstName,e.LastName,DATE_FORMAT(e.JoiningDate, '%d-%b-%Y') as JoiningDate,e.EmpType,a.ID,a.EmpID,a.Description,a.Amount,DATE_FORMAT(a.Date, '%M %Y') as Month,DATE_FORMAT(a.Date, '%d-%b-%Y') as Added,c.Name AS Company,t.Name,t.Type FROM adjustments a LEFT JOIN employees e ON a.EmpID = e.ID LEFT JOIN companies c ON e.CompanyID = c.ID LEFT JOIN adjustmenttypes t ON a.Title = t.ID WHERE a.ID='" .(int)$ID . "'";
	...
	else
	{
		...
		$Reason=dboutput($rows['Description']);
		$Salary=dboutput($rows['Salary']);
		$Title=dboutput($rows['Name']);
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Adjustment Slip</h1>
      <ol class="breadcrumb">
        <li><a href="Adjustments.php"><i class="fa fa-dashboard"></i>Adjustments</a></li>
        <li class="active">Adjustment Slip</li>
      </ol>
    </section>
    <!-- Main content -->
      <section class="content">
       <div class="box-footer no-print" style="text-align:right;">
                ...
                <button class="btn btn-primary margin" type="button" onClick="location.href='Adjustments.php'">Cancel</button>
            </div>
              <?php
		  		echo $msg;
          ...
          <div class="box box-solid" style="border:1px solid black">
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<span style="font-size:15px; font-weight:bold;">ADJUSTMENT VOUCHER FOR THE MONTH OF <?php echo $Month; ?></span>
				</div>
				...
				<div class="col-md-2 col-xs-2" style="border-bottom:1px solid black; width:20%">
				<?php echo ($Type == 0 ? 'Decremental' : 'Incremental'); ?>
				</div>
