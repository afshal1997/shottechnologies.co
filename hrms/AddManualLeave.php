...
{			
	...
	if(isset($_POST["Dates"]) && $_POST["Dates"] != "")
	{
		...
		if($Type == "Auto Leaves")
		{
			$query="SELECT AnualLeaves,CasualLeaves FROM current_leaves_quota WHERE EmpID = ".$EmployeeID."";
	...
	if($msg=="")
	{
		...
		<b>Manual Leave request has been proceed.</b>
		</div>';		
		
		redirect("AddManualLeave.php");	
	}
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Add Manual Leave</h1>
      <ol class="breadcrumb">
        <li><a href="Leaves.php"><i class="fa fa-dashboard"></i>Leaves</a></li>
        <li class="active">Add Manual Leave</li>
      </ol>
    </section>
    <!-- Main content -->
    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      <section class="content">
       <div class="box-footer" style="text-align:right;">
                ...
                <button class="btn btn-primary margin" type="button" onClick="location.href='Leaves.php'">Cancel</button>
            </div>
              <?php
		  		echo $msg;
