...
<meta content='width=device-width, initial-scale=1, maximum-scale=1, Deduction-scalable=no' name='viewport'>
<!-- bootstrap 3.0.2 -->
<!-- jQuery 2.0.2 -->
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				FROM deductions d LEFT JOIN employees e ON d.EmpID = e.ID LEFT JOIN employees a ON d.ApprovedBy = a.ID WHERE d.ID <>0 ";
				if($Keywords != "")
					$query .= " AND (e.FirstName LIKE '%" . dbinput($Keywords) . "%')";
				$query .= " ORDER BY d.EmpID ASC";
  ...
  <aside class="right-side">
    ...
    <section class="content">
      <div class="row">
		...
		?>
                    <tr class="noPrint">
                      <td colspan="11" align="center" class="error"><b>No Deduction listed.</b></td>
                    </tr>
                    <?php 
			}
			else
		...
		?>
                    <tr>
					  ...
					  <td align="center" class="noPrint"><button class="btn btn-info margin" type="button" onClick="location.href='EditDeduction.php?ID=<?php echo $row["ID"]; ?>&EmpID=<?php echo $row["EmpID"]; ?>'">Edit</button></td>
                    </tr>
                    <?php				
				}
			} 
