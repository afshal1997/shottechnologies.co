...
{			
	...
	if($msg=="")
	{
		...
		$query="INSERT INTO grant_leaves_quota SET LeaveDate = NOW(),
		...
		<b>Grant Leave request has been proceed.</b>
		</div>';		
		
		redirect("AddGrantLeave.php");	
	}
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Add Grant Leave</h1>
      <ol class="breadcrumb">
        <li><a href="GrantLeaves.php"><i class="fa fa-dashboard"></i>Grant Leaves</a></li>
        <li class="active">Add Grant Leave</li>
      </ol>
    </section>
    <!-- Main content -->
    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      <section class="content">
       <div class="box-footer" style="text-align:right;">
                ...
                <button class="btn btn-primary margin" type="button" onClick="location.href='GrantLeaves.php'">Cancel</button>
            </div>
              <?php
		  		echo $msg;
