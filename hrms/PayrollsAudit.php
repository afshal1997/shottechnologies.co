...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				FROM payroll p LEFT JOIN employees e ON p.PerformedBy = e.ID WHERE p.ID <>0 ".($_SESSION['PayrollMonthAuditReport'] != "" ? ' AND p.MonthPayroll = \''.$_SESSION['PayrollMonthAuditReport'].'\'' : '')." ".($_SESSION['PayrollCompanyIDAuditReport'] != "" ? ' AND p.CompanyID = \''.$_SESSION['PayrollCompanyIDAuditReport'].'\'' : '')." AND p.Steps > 1";
				if($Keywords != "")
