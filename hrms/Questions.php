...
if($action == "delete")
	{
		if(isset($_REQUEST["ids"]) && is_array($_REQUEST["ids"]))
		{
			...
			mysql_query("DELETE FROM questions  WHERE ID IN (" . $ids . ")") or die (mysql_error());
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				$query="SELECT q.ID, t.TestName, q.Question, q.Status, DATE_FORMAT(q.DateAdded, '%d %b %Y %r') as Added, DATE_FORMAT(q.DateModified, '%d %b %Y %r') as	Updated FROM questions q LEFT JOIN tests t ON t.ID = q.TestID WHERE t.ID <> 0 ";
				if($Keywords != "")
					$query .= " AND (q.Question LIKE '%" . dbinput($Keywords) . "%')";
      ...
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <div class="buttons">
                ...
                <button class="btn btn-success margin" type="button" onClick="location.href='AddNewQuestion.php'">Add New</button>
		...
		?>
                    <tr>
					  ...
					  <td align="center" class="noPrint"><button class="btn btn-info margin" type="button" onClick="location.href='EditQuestion.php?ID=<?php echo $row["ID"]; ?>'">Edit</button></td>
                    </tr>
                    <?php				
				}
			} 
