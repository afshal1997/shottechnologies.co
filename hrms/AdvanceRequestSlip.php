...
include("CheckAdminLogin.php");
	...
	$query="SELECT e.EmpID AS EmpCode,e.Salary,e.FirstName,e.LastName,DATE_FORMAT(e.JoiningDate, '%d-%b-%Y') as JoiningDate,e.EmpType,a.ID,a.EmpID,a.Reason,a.Code,a.Amount,DATE_FORMAT(a.RepaymentDate, '%M %Y') as Month,DATE_FORMAT(a.DateAdded, '%d-%b-%Y') as Added,DATE_FORMAT(a.RepaymentDate, '%d-%b-%Y') as RepaymentDate,c.Name AS Company FROM advance_requests a LEFT JOIN employees e ON a.EmpID = e.ID LEFT JOIN companies c ON e.CompanyID = c.ID WHERE a.ID='" .(int)$ID . "'";
          ...
          <div class="box box-solid" style="border:1px solid black">
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<span style="font-size:15px; font-weight:bold;">ADVANCE REQUEST VOUCHER FOR THE MONTH OF <?php echo $Month; ?></span>
				</div>
				...
				<?php
				$queryCompleted = "SELECT RepaymentDate FROM advances where EmpID = ".$EmployeeID." AND Status = 1 ORDER BY ID DESC Limit 1";
				...
				if($CompletedLoans == 1)
				{
					...
					$CompletedDate = $rowCompleted['RepaymentDate'];
					
					$date1=date_create($CompletedDate);
					echo 'Last completed advance date is '.date_format($date1,"d-M-Y");
				}
				else
				{
					echo 'Information not found about completed advances';
				}
				?>
				</div>
				...
				<div class="col-md-4 col-xs-4" style="text-align:center">
				<span style="border-top:1px solid black">&emsp;&ensp;Supervisor / Manager.&emsp;&ensp;</span>
				</div>
				<div class="col-md-1 col-xs-1" style="text-align:center">
				</div>
