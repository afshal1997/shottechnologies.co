...
<head>
<meta charset="UTF-8">
<title>My Training Results</title>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				$query="SELECT r.ID,r.MaxMarks,r.ObtMarks, t.TestName,r.Grade,r.Attempts, DATE_FORMAT(r.DateAdded, '%D %b %Y<br>%r') AS Added FROM stud_answers r LEFT JOIN tests t ON r.TestID = t.ID WHERE r.ID <> 0 AND r.StudentID = ".$_SESSION['UserID']."";
				if($Keywords != "")
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>My Training Results<small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">My Training Results</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">My Training Results</h3>
