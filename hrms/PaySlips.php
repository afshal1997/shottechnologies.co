...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <aside class="right-side">
	...
	<div class="box-footer no-print" style="text-align:right;">
                 <button class="btn btn-primary margin" type="button" onClick="location.href='AllPaySlips.php?ID=<?php echo $ID; ?>'"><i class="fa fa-print"></i> Print All</button>
          ...
          <br>
			...
			?>
              ...
              <form id="frmPages"  method="post" action="<?php echo $_SERVER["PHP_SELF"];?>?ID=<?php echo $ID; ?>">
				...
				<h4 class="alig">Pay Slips for the Month of <?php echo $PayrollMonth; ?> (<?php echo $num_of_days; ?> Days Salary)</h4><hr>
                ...
                <table style="font-size:12px;" id="dataTable" class="table table-bordered invoice" style="background-color:white">
                  ...
                  <tbody>
                    ...
                    <th colspan=""><?php echo $c; ?></th>
					 ...
					 <th class="no-print"><a <?php echo ($Steps != 3 ? 'disabled' : ''); ?> <?php echo (($_SESSION['RoleID'] == 'Accounts' OR $_SESSION['RoleID'] == 'Audit') ? 'disabled' : ''); ?> href="PaySlip.php?ID=<?php echo $row3['PayrollID']; ?>" class="btn btn-success"><i class="fa fa-file-text-o"></i></a></th>
                    </tr>
