// thookClock, a jQuery Clock with alarm function
...
(function( $ ) {
    ...
    $.fn.thookClock = function(options) {
    // $.fn.thookClock = function(options) {
       ...
       defaults = {
            ...
            $.fn.thookClock.setAlarm = function(newtime){
                el.alarmTime = checkAlarmTime(newtime);
            };

            $.fn.thookClock.clearAlarm = function(){
...
(function( $ ) {
    ...
    // $.fn.thooClock = function(options) {
       ...
       defaults = {
                size: 250,
                dialColor: '#fff',
                dialBackgroundColor:'rgb(41, 151, 69)',
