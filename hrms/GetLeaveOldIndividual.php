...
{			
	...
	if(isset($_POST["Dates"]) && $_POST["Dates"] != "")
	{
		...
		$query="SELECT ".$Type." FROM current_leaves_quota WHERE EmpID = ".$_SESSION['UserID']."";
		$res = mysql_query($query) or die (mysql_error());
		$num = mysql_num_rows($res);
		if($num == 1)
		{
			$r = mysql_fetch_array($res);
			$num_of_available_days = $r[$Type];
	...
	if(isset($_POST["Reason"]))
		...
		else if($num_of_available_days < $num_of_days)
		{
			...
			<i class="fa fa-ban"></i>
			<button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
			<b>You dont have enough '.$Type.' to proceed this request.</b>
			</div>';
		}
		else if($Reason == "")
		{
          ...
          <div class="box">
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<option <?php echo ($Type == "AnualLeaves" ? 'selected' : ''); ?> value="AnualLeaves">Annual Leave</option>
				<option <?php echo ($Type == "SickLeaves" ? 'selected' : ''); ?> value="SickLeaves">Sick Leave</option>
				<option <?php echo ($Type == "CasualLeaves" ? 'selected' : ''); ?> value="CasualLeaves">Casual Leave</option>
				</select>
