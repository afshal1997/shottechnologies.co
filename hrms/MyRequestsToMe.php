...
<head>
<meta charset="UTF-8">
<title>Assigned Requests | Requests Desk</title>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
                ...
                FROM request_desks LEFT JOIN employees ON employees.EMPID = request_desks.AddedBy where request_desks.AssignedTo = '$EMPID'";
				if($Keywords != "")
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Assigned Requests</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Assigned Requests</h3>
		...
		?>
                    ...
                    <td>
					  <button class="btn btn-info margin" type="button" onClick="location.href='MyRequestsToMeEdit.php?ID=<?php echo $row["ID"]; ?>'">Details</button>
					 </td>
					  </td>
                    </tr>
                    <?php				
