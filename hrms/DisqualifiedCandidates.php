...
mysql_error());
			...
			redirect("DisqualifiedCandidates.php");
...
<title>Disqualified Candidates</title>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				FROM candidates c LEFT JOIN jobposts jp ON c.ApplyedFor = jp.ID LEFT JOIN resumes r ON c.Resume = r.ID WHERE c.ID <>0 AND c.IsDisqualified = 'Yes' ";
				if($Keywords != "")
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>Disqualified Candidates <small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Disqualified Candidates</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Disqualified Candidates</h3>
		...
		?>
                    <tr class="noPrint">
                      <td colspan="11" align="center" class="error"><b>No Disqualified Candidate listed.</b></td>
                    </tr>
                    <?php 
			}
			else
