...
{	
	...
	if($msg=="")
	{
		$r = mysql_query("SELECT UserName FROM employees WHERE 
		UserName='".dbinput($UserName)."' AND ID <> '".(int)$ID."'") or die(mysql_error());
...
else
{
	...
	else
	{
		...
		$LeaveAdjustPolicy=$row["LeaveAdjustPolicy"];	
				  ...
				  <div class="box box-solid">
						...
						<div style="padding:15px;" class="box-primary">
						  ...
						  <div class="box-body">
							...
							<div class="form-group">
							  <label id="labelimp" for="flPage" class="labelimp" >Upload Photo:</label>
							...
							<p>
								...
								{
								echo '<img class="thumbnail" src="'.DIR_EMPLOYEEPHOTOES.$Photo.'" height="100">';
								}
								?>
							</p>
