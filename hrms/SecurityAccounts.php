...
if($action == "delete")
	{
		if(isset($_REQUEST["ids"]) && is_array($_REQUEST["ids"]))
		{
			...
			{
			mysql_query("DELETE FROM security  WHERE ID IN (" . $BID . ")") or die (mysql_error());
			...
			<b>Delete All selected Security Accounts.</b>
			</div>';
			redirect("SecurityAccounts.php");
		...
		else
		{
			...
			<i class="fa fa-ban"></i>
			<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
			<b>Please select Security Account to delete.</b>
			</div>';
		}
	}
?>
...
<head>
<meta charset="UTF-8">
<title>Security Accounts</title>
<meta content='width=device-width, initial-scale=1, maximum-scale=1, Security Account-scalable=no' name='viewport'>
<!-- bootstrap 3.0.2 -->
<!-- jQuery 2.0.2 -->
...
<script language="javascript">
	...
	function doDelete()
	{
		if($(".chkIds").is(":checked"))
		{
			...
			alert("Please select Security Account to delete");
	}
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				$query="SELECT d.ID,e.EmpID,e.FirstName,e.LastName,e.Department,e.Designation,d.Status,DATE_FORMAT(d.DateAdded, '%D %b %Y<br>%r') AS Added,DATE_FORMAT(d.DateModified, '%D %b %Y<br>%r') AS Updated
				FROM security d LEFT JOIN employees e ON d.EmpID = e.ID WHERE d.ID <>0 ";
				if($Keywords != "")
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Security Accounts <small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Security Accounts</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Security Accounts</h3>
			  <div class="buttons">
                <button class="btn btn-success margin" type="button" onClick="location.href='AddNewSecurityAccount.php'">Add New</button>
		...
		?>
                    <tr class="noPrint">
                      <td colspan="11" align="center" class="error"><b>No Security Account listed.</b></td>
                    </tr>
                    <?php 
			}
			else
		...
		?>
                    <tr>
					  ...
					  <td align="center" class="noPrint"><button class="btn btn-info margin" type="button" onClick="location.href='EditSecurityAccount.php?ID=<?php echo $row["ID"]; ?>'">Edit</button></td>
                    </tr>
                    <?php				
				}
			} 
