...
<body>
    <a class="no-print" title="" href="https://hrms.shottechnologies.co/chatting/" target="_blank"><div style="width:50px;height:50px;border-radius:0 5px 5px 0;position:fixed;top:280px;left:0px;background-color:black;z-index:9999999999999;font-size: 25px;display: flex;justify-content: center;align-items: center;color: #fff;"><i class="fa fa-comments-o" aria-hidden="true"></i></a>
</div>
			...
			<div class="main-row">
				<div class="can-col">
					<div class="clock-wrap">
						<div class="clock-box">
						    <p class="clock-title">Pakistan Time</p>
						    <div id="pstTime"></div>
						</div>
						<div class="clock-box">
...
<!--<script src="timemachineLatest/js/custom-2.js"></script> -->
