...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				$query="SELECT l.ID,l.Approved,l.AdvanceGranted,l.Reason,l.DisapproveReason,l.Code,l.Amount,e.EmpID,e.FirstName,e.LastName,e.Department,e.Designation,a.FirstName AS fn,a.LastName AS ln,a.Department AS dep,a.Designation AS des,DATE_FORMAT(l.DateAdded, '%D %b %Y') AS Added,DATE_FORMAT(l.DateModified, '%D %b %Y') AS Updated
				FROM advance_requests l LEFT JOIN employees e ON l.EmpID = e.ID LEFT JOIN employees a ON l.ApprovedBy = a.ID WHERE l.ID <>0 AND l.EmpID = ".$_SESSION['UserID']."";
				if($Keywords != "")
					$query .= " AND (l.Code LIKE '%" . dbinput($Keywords) . "%')";
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> My Advance Requests <small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">My Advance Requests</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">My Advance Requests</h3>
			  <div class="buttons">
                
                <button type="button" class="btn btn-success margin" onClick="location.href='GetAdvance.php'" style="margin-right:auto">New Advance Request</button>
		...
		?>
                    <tr>
					  ...
					  <td><?php echo dboutput($row["DisapproveReason"]); ?></td>
