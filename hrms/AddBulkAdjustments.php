...
{	
    ...
    //Import uploaded file to Database adjustments
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
		...
		{	
			...
			$import="INSERT into adjustments(EmpID,FrwdEmpID,Approved,ApprovedBy,Title,Amount,Percentage,Type,Date) values('$EmpID','0','1','".$_SESSION['UserID']."','$data[1]','$data[2]','$data[2]','$data[3]',NOW())";
			//echo $import;exit();
    ...
    $_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
		...
		<b>Adjustments has been Uploaded.</b>
		</div>';
	}
	else
	{
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
		<b>Adjustments Not Uploaded.</b>
		</div>';
	}

		redirect("AddBulkAdjustments.php");	
	}
...
<head>
<meta charset="UTF-8">
<title>Add Basic Adjustments</title>
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<div class="form-group">
                  <label id="labelimp" for="Adjustments" class="labelimp" >Upload (CSV): </label>
                  <input type="file" id="Adjustments" name="flPage" />
                </div>
                <input type="hidden" name="action" value="submit_form" />
              </div>
              <!-- /.box-body -->
