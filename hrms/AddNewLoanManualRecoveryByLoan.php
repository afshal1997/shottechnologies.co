...
include("CheckAdminLogin.php");
	...
	$query = "SELECT EmpID,RemainingAmount FROM loans where ID = ".$LoanID."";
	...
	else
	{
		...
		redirect("EditLoan.php?ID=".$LoanID);	
	}
...
{			
	...
	if($msg=="")
	{
		...
		redirect("AddNewLoanManualRecoveryByLoan.php?ID=".$LoanID);	
	}
...
?>
  ...
  <aside class="right-side">
    ...
    <!-- Main content -->
    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>?ID=<?php echo $LoanID; ?>" method="post" enctype="multipart/form-data" name="frmPage">
