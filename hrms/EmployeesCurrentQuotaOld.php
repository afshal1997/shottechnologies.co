...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				$query1="SELECT AnualLeaves,SickLeaves,CasualLeaves FROM leaves_quota  WHERE ID <>0 AND EmpID=".(int)$Employee." AND Approved = 1";
				...
				if($num1 == 1)
				{
					...
					$query2="SELECT AnualLeaves,SickLeaves,CasualLeaves FROM current_leaves_quota  WHERE ID <>0 AND EmpID=".(int)$Employee."";
