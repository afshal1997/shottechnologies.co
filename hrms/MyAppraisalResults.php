...
<!--?php
if($_SESSION['RoleID'] == 'Administrator' OR $_SESSION['RoleID'] == 'HR' OR user_authentication($_SESSION['UserID'],'TrainExeMyTrangsReslt') OR external_user_authentication($_SESSION['UserID'],'TrainExeMyTrangsReslt'))
...
<head>
<meta charset="UTF-8">
<title>My Appraisal Results</title>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				$query="SELECT r.ID,t.Title,r.EmpMarks,r.SupMarks,DATE_FORMAT(r.DateAdded, '%D %b %Y<br>%r') AS Added FROM appraisals_result r LEFT JOIN appraisals t ON r.AppraisalID = t.ID WHERE r.ID <> 0 AND r.EmpID = ".$_SESSION['UserID']."";
				if($Keywords != "")
					$query .= " AND (t.Title LIKE '%" . dbinput($Keywords) . "%')";
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>My Appraisal Results<small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">My Appraisal Results</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">My Appraisal Results</h3>
		...
		?>
                    <tr class="noPrint">
                      <td colspan="11" align="center" class="error"><b>No Appraisal Result listed.</b></td>
                    </tr>
                    <?php 
			}
			else
		...
		?>
                    <tr>
					  ...
					  <td><?php echo dboutput($row["EmpMarks"]); ?></td>
