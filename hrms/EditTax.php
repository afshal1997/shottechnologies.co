...
{	
	...
	if($msg=="")
	{
		$r = mysql_query("SELECT Title FROM taxes WHERE 
...
{
	$query="SELECT ID, Approved,ApprovedBy,FrwdEmpID,Title,Percentage,Date,Description FROM taxes WHERE  ID='" . (int)$ID . "'";
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>Edit Tax</h1>
      <ol class="breadcrumb">
        <li><a href="Taxes.php"><i class="fa fa-dashboard"></i>Taxs</a></li>
    ...
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>?ID=<?php echo $ID; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      ...
      <section class="content">
        <div class="box-footer" style="text-align:right;">
          ...
          <button class="btn btn-primary margin" type="button" onClick="location.href='Taxes.php'">Cancel</button>
        </div>
        <?php
			  	echo $msg;
