...
mysql_error());
			...
			redirect("OnBoardingEmployees.php");
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Onboarding Employees<small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Onboarding Employees</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Onboarding Employees</h3>
		...
		?>
                   <tr>
					 ...
					 <td><?php if(dboutput($row["Status"])=='Active'){echo '<span style="background:linear-gradient(45deg, #0d99e0, #0855ca);color:white">&nbsp;Active&nbsp;</span>';}else{echo '<span style="background-color:red;color:white">&nbsp;Deactive&nbsp;</span>';} ?></td>
					  <td align="center" class="noPrint"><button class="btn btn-info margin" type="button" onClick="location.href='OnboardingProfileNote.php?ID=<?php echo $row["EmpID"]; ?>'">Note</button> | <button class="btn btn-info margin" type="button" onClick="location.href='OnboardingProfileNote.php?ID=<?php echo $row["ID"]; ?>'">Email</button></td>
                    </tr>
                    <?php
				$i++;
				}
