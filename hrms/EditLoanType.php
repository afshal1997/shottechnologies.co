...
{	
	...
	if($Name == "")
	{
		...
		<b>Please enter Loan Type Name.</b>
		</div>';
	}
	...
	if($msg=="")
	{
			...
			$query="UPDATE loantypes SET DateModified=NOW(),
			Name = '" . dbinput($Name) . "',
			Status='".(int)$Status . "'
			WHERE ID='".(int)$ID."'";
			...
			$msg='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>Loan Type has been Updated.</b>
			</div>';
...
{
	$query="SELECT ID,Status,Name FROM loantypes WHERE  ID='" . (int)$ID . "'";
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="LoanTypes.php"><i class="fa fa-dashboard"></i>Loan Types</a></li>
    ...
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>?ID=<?php echo $ID; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      ...
      <section class="content">
        <div class="box-footer" style="text-align:right;">
          ...
          <button class="btn btn-primary margin" type="button" onClick="location.href='LoanTypes.php'">Cancel</button>
        </div>
        <?php
			  	echo $msg;
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<div class="form-group">
				  <label id="labelimp" class="labelimp" for="Name">Loan Type Name: </label>
				  <?php 
