...
{			
	...
	if($msg=="")
	{
		...
		$query="INSERT INTO reimbursements SET 
				Title = '" . dbinput($Title) . "',
				Amount = '" . dbinput($Amount) . "',
				Date = '" . dbinput($Date) . "',
				Type = '" . dbinput($Type) . "',
				Receipt = '" . dbinput($Receipt) . "',
				EmpID='".(int)$EmpID . "',
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>Reimbursement has been added.</b>
		</div>';		
		
		redirect("AddNewReimbursement.php");	
	}
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="Reimbursements.php"><i class="fa fa-dashboard"></i>Reimbursements</a></li>
        <li class="active">Add Reimbursement</li>
      </ol>
    </section>
    <!-- Main content -->
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>" method="post" enctype="multipart/form-data" name="frmPage">
      <section class="content">
       <div class="box-footer" style="text-align:right;">
                ...
                <button class="btn btn-primary margin" type="button" onClick="location.href='Reimbursements.php'">Cancel</button>
            </div>
              <?php
		  		echo $msg;
          ...
          <div class="box">
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<div class="form-group">
                  <label id="labelimp" for="Type" >Reimbursement Type: </label>
				  <select name="Type" id="Type" class="form-control">
					<option value="" >Select Type</option>
					<option <?php echo ($Type == 'Transportation' ? 'selected' : '');?> value="Transportation" >Transportation</option>
					<option <?php echo ($Type == 'Boarding' ? 'selected' : '');?> value="Boarding" >Boarding</option>
					<option <?php echo ($Type == 'Lodging' ? 'selected' : '');?> value="Lodging" >Lodging</option>
					<option <?php echo ($Type == 'Communication' ? 'selected' : '');?> value="Communication" >Communication</option>
					<option <?php echo ($Type == 'Other' ? 'selected' : '');?> value="Other" >Other</option>
				  </select>
                </div>
				
				<div class="form-group">
                  <label id="labelimp" class="labelimp" for="Receipt">Receipt #: </label>
                  <?php 
				echo '<input type="text" maxlength="100" id="Receipt" name="Receipt" class="form-control"  value="'.$Receipt.'" />';
				?>
                </div>
