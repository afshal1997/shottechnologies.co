          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <?php if($_SESSION['RoleID'] == 'Administrator' OR $_SESSION['RoleID'] == 'HR' OR $_SESSION['RoleID'] == 'Employee'){ ?>
                <button class="btn btn-success margin" type="button" onClick="location.href='AddSurveyForm.php'">Add New</button>
                <?php } ?>
