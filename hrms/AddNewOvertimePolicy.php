...
{	
	...
	if($msg=="")
	{
			$query="INSERT INTO overtime_policies SET DateAdded=NOW(),
				Name = '" . dbinput($Name) . "',
			...
			$_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>Overtime Policy has been Added.</b>
			</div>';
			
			redirect("AddNewOvertimePolicy.php");
	}
...
<head>
<meta charset="UTF-8">
<title>Add Overtime Policy</title>
