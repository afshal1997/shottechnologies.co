...
// if(isset($_SESSION['Login']) && $_SESSION['Login']==true)
	...
	if(isset($_POST["action"]) && $_POST["action"] == "submit_form")
	{
		...
		{	
					...
					if($num == 0)
					{
						mysql_query("INSERT INTO user_login_history SET UserID = '".(int)$UserID."', LoginTime=CURRENT_TIME(), LoginDate=CURRENT_DATE(),DateAdded=CURRENT_DATE()") or die(mysql_error());
						$id=mysql_insert_id();
						...
						$from_time=strtotime("".GRACE_ARRIVAL_TIME."");
						// echo $from_time;
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
  <div class="biomatrics">
	...
	<img onclick="changeArrival()" src="images/arrivaltimeuncheck.png" id="arrivalImage" class="margin" style="cursor:pointer;width:20%;position:relative;top: -34.5%;left: 10%;">
 </div>
  </form>
  <?php 
