...
{			
	...
	if(isset($_POST["Hours"]) && ctype_digit($_POST['Hours']))
	...
	if(isset($_POST["FrwdEmpID"]) && ctype_digit($_POST['FrwdEmpID']))
		...
		else if($Hours == 0)
		{
			...
			<i class="fa fa-ban"></i>
			<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
			<b>Please Enter Number of Hours.</b>
			</div>';
		}
		else if($Date == "")
		{
	...
	if($msg=="")
	{
		...
		$query="INSERT INTO Overtimes SET 
				Title = '" . dbinput($Title) . "',
				Date = '" . dbinput($Date) . "',
				Hours = '" . (int)$Hours . "',
				EmpID='".(int)$EmpID . "',
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>Overtime has been added.</b>
		</div>';		
		
		redirect("AddNewOvertime.php");	
	}
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> Add Overtime</h1>
      <ol class="breadcrumb">
        <li><a href="Overtimes.php"><i class="fa fa-dashboard"></i>Overtimes</a></li>
        <li class="active">Add Overtime</li>
      </ol>
    </section>
    <!-- Main content -->
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>" method="post" enctype="multipart/form-data" name="frmPage">
      <section class="content">
       <div class="box-footer" style="text-align:right;">
                ...
                <button class="btn btn-primary margin" type="button" onClick="location.href='Overtimes.php'">Cancel</button>
            </div>
              <?php
		  		echo $msg;
          ...
          <div class="box">
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<div class="form-group">
                  <label id="labelimp" class="labelimp" for="Hours">Hours </label>
                  <?php 
				echo '<input type="num" maxlength="100" id="Hours" name="Hours" class="form-control"  value="'.$Hours.'" />';
				?>
                </div>
