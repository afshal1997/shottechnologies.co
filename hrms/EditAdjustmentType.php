...
{	
	...
	if(isset($_POST["Type"]) && ((int)$_POST["Type"] == 0 || (int)$_POST["Type"] == 1))
	...
	if($Name == "")
	{
		...
		<b>Please enter Adjustment Type Name.</b>
		</div>';
	}
	...
	if($msg=="")
	{
			...
			$query="UPDATE adjustmenttypes SET DateModified=NOW(),
			Name = '" . dbinput($Name) . "',
			Status='".(int)$Status . "',
			Type='".(int)$Type . "'
			WHERE ID='".(int)$ID."'";
			...
			$msg='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>Adjustment Type has been Updated.</b>
			</div>';
...
{
	$query="SELECT ID,Status,Name,Type FROM adjustmenttypes WHERE  ID='" . (int)$ID . "'";
	...
	if($num==0)
	{
		$_SESSION["msg"]='<div class="alert alert-danger alert-dismissable">
			<i class="fa fa-ban"></i>
			<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
			<b>Invalid Adjustment Type ID.</b>
		</div>';
...
<head>
<meta charset="UTF-8">
<title>Edit Adjustment Type</title>
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>Edit Adjustment Type</h1>
      <ol class="breadcrumb">
        <li><a href="AdjustmentTypes.php"><i class="fa fa-dashboard"></i>Adjustment Types</a></li>
        <li class="active">Edit Adjustment Type</li>
      </ol>
    </section>
    <!-- Main content -->
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>?ID=<?php echo $ID; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      ...
      <section class="content">
        <div class="box-footer" style="text-align:right;">
          ...
          <button class="btn btn-primary margin" type="button" onClick="location.href='AdjustmentTypes.php'">Cancel</button>
        </div>
        <?php
			  	echo $msg;
            ...
            <div style="padding:15px;" class="box-primary">
              ...
              <div class="box-body">
				...
				<div class="form-group">
				  <label id="labelimp" class="labelimp" for="Name">Adjustment Type Name: </label>
				  <?php 
