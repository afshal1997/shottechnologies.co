      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-xs-4">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3> <?php echo get_my_attendance($Month,$Year,$Employee,1);?></h3>
        ...
        <div class="col-lg-4 col-xs-4">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3> <?php echo get_my_attendance($Month,$Year,$Employee,2);?></h3>
              <p> On time</p>
            </div>
            <div class="icon"> <i class="ion ion-stats-bars"></i> </div>
            <a href="#" class="small-box-footer"> More info <i class="fa fa-arrow-circle-right"></i> </a> </div>
        ...
        <div class="col-lg-4 col-xs-4">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3> <?php echo get_my_attendance($Month,$Year,$Employee,3);?></h3>
              <p> Late</p>
            </div>
            <div class="icon"> <i class="ion ion-stats-bars"></i> </div>
            <a href="#" class="small-box-footer"> More info <i class="fa fa-arrow-circle-right"></i> </a> </div>
