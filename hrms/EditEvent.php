...
{	
	...
	if($msg=="")
	{
		$r = mysql_query("SELECT Title FROM events WHERE 
...
{
	$query="SELECT ID, Title,StartDate,EndDate,StartTime,EndTime,Color FROM events WHERE  ID='" . (int)$ID . "'";
...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>Edit Event</h1>
      <ol class="breadcrumb">
        <li><a href="Events.php"><i class="fa fa-dashboard"></i>Events</a></li>
    ...
    <form role="form" action="<?php echo $_SERVER["PHP_SELF"];?>?ID=<?php echo $ID; ?>" method="post" enctype="multipart/form-data" name="frmPage">
      ...
      <section class="content">
        <div class="box-footer" style="text-align:right;">
          ...
          <button class="btn btn-primary margin" type="button" onClick="location.href='Events.php'">Cancel</button>
        </div>
        <?php
			  	echo $msg;
