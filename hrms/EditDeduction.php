...
{	
	...
	if($msg=="")
	{
			...
			WHERE ID='".(int)$ID."'";
			mysql_query($query) or die ('Could not update Deduction because: ' . mysql_error());
			//echo $query;
			
			$msg='<div class="alert alert-success alert-dismissable">
				<i class="fa fa-ban"></i>
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<b>Deduction has been Updated.</b>
			</div>';
...
{
	$query="SELECT ID, Approved,ApprovedBy,EmpID,FrwdEmpID,Title,Amount,Percentage,Date,Type,Description FROM deductions WHERE  ID='" . (int)$ID . "'";
              ...
              <div class="box-body">
				...
				<div class="form-group">
				  ...
				  <select name="Title" id="Title" class="form-control">
					...
					<?php
					 $query = "SELECT ID,Name FROM deductiontypes where Status = 1 ORDER BY Name ASC";
