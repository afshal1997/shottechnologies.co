...
{			
	...
	if($msg=="")
	{
		...
		$query="INSERT INTO basicsalary SET 
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>Basic Salary has been added.</b>
		</div>';		
		
		redirect("AddNewBasicSalary.php");	
	}
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Basic Salary</li>
      </ol>
    </section>
    <!-- Main content -->
