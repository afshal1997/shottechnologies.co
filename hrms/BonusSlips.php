          ...
          <br>
			...
			?>
              ...
              <form id="frmPages"  method="post" action="<?php echo $_SERVER["PHP_SELF"];?>?ID=<?php echo $ID; ?>">
				...
				<h4 class="alig">Bonus Slips for the Month of <?php echo $BonusMonth; ?></h4><hr>
                ...
                <table style="font-size:12px;" id="dataTable" class="table table-bordered invoice" style="background-color:white">
                  ...
                  <tbody>
                    ...
                    <th colspan=""><?php echo $c; ?></th>
					 ...
					 <th class="no-print"><a <?php echo ($Steps != 3 ? 'disabled' : ''); ?> <?php echo (($_SESSION['RoleID'] == 'Accounts' OR $_SESSION['RoleID'] == 'Audit') ? 'disabled' : ''); ?> href="BonusSlip.php?ID=<?php echo $row3['BonusID']; ?>" class="btn btn-success"><i class="fa fa-file-text-o"></i></a></th>
                    </tr>
