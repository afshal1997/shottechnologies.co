...
{	
	...
	if($msg=="")
	{
			...
			$msg='<div class="alert alert-success alert-dismissable">
				...
				<b>Interview has been Updated.</b>
			</div>';
...
{
	$query="SELECT ID, Title,Post,Candidates,Description,StartDate,EndDate,StartTime,EndTime,Color FROM interviews WHERE  ID='" . (int)$ID . "'";
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Interview</li>
      </ol>
    </section>
    <!-- Main content -->
