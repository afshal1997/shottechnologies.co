...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <?php
		include_once("Sidebar.php");
				...
				FROM candidates c LEFT JOIN jobposts jp ON c.ApplyedFor = jp.ID LEFT JOIN resumes r ON c.Resume = r.ID WHERE c.ID <>0 AND c.IsShortlist = 'No' AND c.IsDisqualified = 'No' ";
				if($Keywords != "")
  ...
  <aside class="right-side">
    ...
    <section class="content">
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <div class="buttons" style="width:50%">
                ...
                <button class="btn btn-success margin" type="button" onClick="location.href='AddNewCandidate.php'">Add New</button>
		...
		?>
                    <tr class="noPrint">
                      <td colspan="11" align="center" class="error"><b>No Candidate listed.</b></td>
                    </tr>
                    <?php 
			}
			else
		...
		?>
                    <tr>
					  ...
					  <td align="center" class="noPrint"><button class="btn btn-info margin" type="button" onClick="location.href='EditCandidate.php?ID=<?php echo $row["ID"]; ?>'">Edit</button></td>
                    </tr>
                    <?php				
				}
			} 
