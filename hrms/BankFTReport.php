			   ...
			   <div id="tblExport">
				...
				<table style="font-size:12px;" id="dataTable"  class="table table-bordered invoice" style="background-color:white">
                  ...
                  <tbody>
					...
					//echo '(Pakistani Rupees '.convertNumber($EnglishCurrency).' Only) from '.$rowB['CompanyName'].' account # '.$rowB['AccountNo'].' to our staff account through excel sheet attached, which we will email you after your acknowledgement.';
                    ...
                    <!--<th colspan=""><?php //echo $c; ?></th>-->
					  ...
					  <th>FT</th>
					  <th>Salary <?php echo $PayrollMonth; ?></th>
                    </tr>
